...
const ColorPicker = (data: Note) => {
  ...
  return (
    <div className="rounded-lg border border-gray-300 bg-white shadow shadow-gray-400 absolute w-[180px] sm:w-auto z-50 mt-6 ml-10 flex flex-wrap items-center justify-center p-4 gap-2">
        {colors.map(color => (
            <div 
            key={color.color}
